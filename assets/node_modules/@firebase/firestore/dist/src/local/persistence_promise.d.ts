...
export declare class PersistencePromise<T> {
    ...
    static waitFor(all: Iterable<PersistencePromise<any>>): PersistencePromise<void>;
     ...
     */
    static forEach<K>(collection: Iterable<K>, f: (item: K) => PersistencePromise<void>): PersistencePromise<void>;
}
